...
import { UnitManipulatingItemEvent } from "./events/unit/UnitManipulateItemEvent";
...
export class Unit extends Handle {
  ...
  public addEventListener(type: "dropitem", listener: (event: UnitManipulatingItemEvent) => void, once?: EventSettings): void;
  public addEventListener(type: "pickupitem", listener: (event: UnitManipulatingItemEvent) => void, once?: EventSettings): void;
  public addEventListener(type: "useitem", listener: (event: UnitManipulatingItemEvent) => void, once?: EventSettings): void;
